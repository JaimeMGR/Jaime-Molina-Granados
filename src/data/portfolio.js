...
const projectsES = [
  ...
  {
    title: "MaxManga — Android + comunidad",
    desc:
      "Proyecto final de DAM compuesto por dos aplicaciones Android integradas: MaxManga, orientada a la lectura y gestión de libros en PDF, y MaxManga Community, centrada en perfiles de usuario y chat en tiempo real con mensajes e imágenes.",
    tags: [
      "Kotlin",
      "Android",
      "Firebase",
...
const projectsEN = [
  ...
  {
    title: "MaxManga — Android + Community",
    desc:
      "Final DAM project composed of two integrated Android applications: MaxManga, focused on reading and managing PDF books, and MaxManga Community, focused on user profiles and real-time chat with text and image messages.",
    tags: [
      "Kotlin",
      "Android",
      "Firebase",
...
const base = {
  ...
  linkedin:
    "https://www.linkedin.com/in/jaime-molina-granados-a27794138/",
